from .Importance_Weighting import ImportanceWeighting as IW
import numpy as np


def calculate_IW_on_chunk(data, Y_PRED_PROBA_start):
    ...
    iw = IW(CLIENT_MODEL_Y_PRED_PROBA, CLIENT_MODEL_PRED, 'y_true', cont_features, cat_features,
                    ['auroc', 'accuracy', 'f1'])
