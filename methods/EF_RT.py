from .RT import ReverseTraining
import numpy as np


def calculate_RT_on_chunk(
        data,
        Y_PRED_PROBA_start):
    ...
    estimator = ReverseTraining(CLIENT_MODEL_Y_PRED_PROBA, CLIENT_MODEL_PRED, 'y_true', cont_features, cat_features,
                                ['auroc', 'accuracy', 'f1'])
